...
class LTEAdminSite(AdminSite):
    ...
    def get_auth_app_urls(self):
        ...
        urlpatterns = [
            ...
            url(r'^profile/$',
                views.accounts.ProfileDetailView.as_view(registry=self._registry),
                name='profile',
            ),
            url(r'^profile/edit/$',
                views.accounts.ProfileUpdateView.as_view(registry=self._registry),
                name='profile_update',
            ),
            url(r'^password-change/$',
                views.accounts.PasswordChangeView.as_view(registry=self._registry),
